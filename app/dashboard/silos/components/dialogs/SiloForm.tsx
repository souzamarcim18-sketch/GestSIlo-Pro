...
const siloSchema = z.object({
  ...
  volume_ensilado_ton_mv: z.union([z.number().positive('Volume deve ser positivo'), z.null()]).optional(),
  comprimento_m: z.union([z.number().positive('Comprimento deve ser positivo'), z.null()]).optional(),
  largura_m: z.union([z.number().positive('Largura deve ser positiva'), z.null()]).optional(),
  altura_m: z.union([z.number().positive('Altura deve ser positiva'), z.null()]).optional(),
  cultura_ensilada: z.string().optional(),
  materia_seca_percent: z.union([z.number().min(0).max(100), z.null()]).optional(),
