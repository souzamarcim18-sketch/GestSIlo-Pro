...
export default function FinanceiroPage() {
  ...
  const LancamentoRow = ({ l }: { l: Financeiro }) => (
    <TableRow>
      ...
      <TableCell
        className={`font-bold tabular-nums ${l.tipo === 'Receita' ? 'text-green-600 dark:text-primary' : 'text-destructive'}`}
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <TrendingUp className="h-4 w-4 text-green-500 dark:text-primary" aria-hidden="true" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-600 dark:text-primary" aria-labelledby="card-receitas" aria-live="polite">
