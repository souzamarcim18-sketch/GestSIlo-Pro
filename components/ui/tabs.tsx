...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        // Base
        "relative inline-flex h-full flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-3 py-2.5 text-sm font-medium whitespace-nowrap text-foreground/70 transition-all cursor-pointer",
        // Vertical layout
        ...
        // Dark mode (texto inativo)
        "dark:text-muted-foreground dark:hover:text-foreground",
        // Variante LINE — preserva comportamento original
        ...
        // ESTADO ATIVO — verde da marca (variante default)
