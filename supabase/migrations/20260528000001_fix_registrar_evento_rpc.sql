-- Corrige a RPC registrar_evento_com_status:
-- 1. Remove coluna 'metodo' que não existe em eventos_rebanho
-- 2. Corrige 'condicao_corporal' → 'escore_condicao_corporal'
-- 3. Corrige 'resultado' → 'resultado_prenhez'
-- 4. Expõe 'tipo_cobertura' (já existe na tabela desde fase2)
